package com.desenvBack.dslist.entities;
...
public class Game {
	...
	public Game(
				Long id, String title, Integer year, String genre, String platforms, Double score, String imgUrl,
				String shortDescription, String longtDescription
			) {
		this.id = id;
		this.title = title;
		this.year = year;
